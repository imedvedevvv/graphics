...
public class Main extends JFrame{
    ...
    public void createSceneGraph(SimpleUniverse su){
        ...
        TextureLoader t = new TextureLoader("D:\\IdeaProjects\\Lab6\\src\\sample\\source_folder\\ocean.jpg", myCanvas3D);
        Background fishBackground =  new Background(t.getImage());

        Scene fishScene = null;
        try{
            fishScene = f.load("D:\\IdeaProjects\\Lab6\\src\\sample\\models\\fish.obj");
        }
        catch (Exception e){
        ...
        RotationInterpolator fin1rot = new RotationInterpolator(fin1_1RotAlpha, fin1TG, fin1RotAxis,(float) 0.0f, (float) Math.PI/3);
        ...
        RotationInterpolator fin2rot = new RotationInterpolator(fin2_1RotAlpha, fin2TG, fin2RotAxis,(float) 0.0f, (float) Math.PI/3);
        ...
        headShape.setAppearance(bodyApp);
    ...
    private Appearance addAppearance(){
        ...
        boatAppearance.setTexture(getTexture("D:\\IdeaProjects\\Lab6\\src\\sample\\source_folder\\ocean.jpg"));
    ...
    public void addLight(SimpleUniverse su){
        ...
        Color3f lightColour1 = new Color3f(100/255f, 100/255f, 100/255f);
